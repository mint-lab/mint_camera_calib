...
def generate_img(obj_pts, K, dist_coef, dist_type, save_path):
    ...
    # 5 img
    # cam_ori = [[-8., -5, 0.], [-10., -5, 0.], [-5., -5., 5], [-8., -10., 5.], [-8., -8, 0.]]
    # cam_pos = [[0.2, 0.05, -0.35], [0.2, 0.05, -0.4], [0.25, 0.1, -0.45], [0.3, 0., -0.5],[0.15, 0.05, -0.5]]

    # 10 img
    # cam_ori = [[-8., -5, 0.], [-8., -10., 5.]]
...
def make_data(proj_model, dist_model, data_path, ind, f_init = [820, 840, 860, 880, 900, 920, 940, 960, 980, 1000]):
    model_ind = []
    synthetic_path = []
    cam_model = [] 
    K_original = []
